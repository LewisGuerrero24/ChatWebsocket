...
def main():
   ...
   instances = [SocketServer(socketio, app, UserService(TemporalUsuario)), AuthManager(app, User, Rol), SocketController(app, UserService(TemporalUsuario)),  UserController(app, UsuarioService(User, Rol))]
