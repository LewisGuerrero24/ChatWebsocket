    ...
    <div className="bg-gray-100 min-h-screen py-12 flex items-center justify-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-lg transition-transform transform hover:scale-105">
          ...
          <div className="p-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Registrate</h2>
            <p className="text-4xl font-bold text-gray-800 mb-2">Registro</p>
          ...
          <div className="p-4">
            <Link to={'register'}>
              <button className="w-full bg-red-500 text-white rounded-full px-4 py-2 hover:bg-red-700 focus:outline-none focus:shadow-outline-green active:bg-green-800">
                Acceder
              </button>
            </Link>
          </div>
