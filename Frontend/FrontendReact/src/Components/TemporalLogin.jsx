    ...
    <div className="bg-white px-10 py-8 rounded-xl w-screen shadow-md max-w-sm">
      <div className="space-y-4">
        ...
        <div>
          ...
          <input ype="text" value={name} onChange={(e)=> setName(e.target.value)}  className="bg-indigo-100 px-4 py-2 outline-none rounded-md w-full" />
        </div>
      </div>
      <button  type="submit" className="mt-4 w-full bg-emerald-500 text-indigo-100 py-2 rounded-md text-lg tracking-wide">Iniciar</button>
    </div>
  </form>
</div>
    </>
