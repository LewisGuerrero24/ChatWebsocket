...
const ChatUsers = ({ name, nameSendUser, connected, socket, initialMessages}) => {
  ...
  if(nameNew == "Nick"){
    return (<div class='flex flex-col h-screen w-full p-6 bg-gradient-to-r from-blue-500 to-indigo-500'>
      <div class="flex justify-center items-center w-full h-full">
        <div class="flex justify-center items-center w-full">
          <div class="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-full max-w-[720px]">
            <div class="p-6">
